...
How about if we match the second survey of the primary forest to the
first survey of the secondary forest?
...
That has closed the gap between means a little - for some species more
than others. It looks like there’s better overlap in the range of sizes
between the forest types.

Maybe there is more range in primary forest seedling size because of the
two cohorts!
...
It looks like some species do better in the secondary forest and some in
the primary, but perhaps the secondary forest seedlings are just ahead
...
Seems like a few points are dragging down the secondary forest growth
rate - perhaps just smaller sample size as more trees have died.
