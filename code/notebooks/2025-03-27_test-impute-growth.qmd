...
By imputing DBH we will get 260 extra measurements. 
DBH is mostly missing at the start of the experiment when the trees were too small to take DBH.
...
DBH over time (incl. missing values) is predicted by forest type and basal diameter.
Missing basal diameter values are predicted by DBH.
...
Bad chains since I didn't run very long and little data, but ok for testing.
...
Not a 1-to-1 fit since DBH is also predicted by time, forest type & tree ID.
