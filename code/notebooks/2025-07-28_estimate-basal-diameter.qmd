...
The taper model in 
[Philipson _et al._ 2020](https://doi.org/10.1126/science.aay4490) comes from
[Cushman _et al._ 2014](https://doi.org/10.1111/2041-210X.12187).

For the taper parameter in the equation (*b1*), 
[Philipson _et al._ 2020](https://doi.org/10.1126/science.aay4490) 
use -0.029, I assume they got this value by fitting to their own data.
...
Optimising the taper parameter (*b1*) at the species-level 
reduces RMSE by 0.105844.
