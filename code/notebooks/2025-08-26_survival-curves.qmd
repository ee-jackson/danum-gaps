---
title: "Checking survival curves"
...
> The Weibull probability density is parametrized in brms in terms of shape  and scale parameter. Instead of directly modeling the scale  (as done in many other time to event programs), brms models the mean of the Weibull distribution. 
...
with the predictions from method 1,
the difference between mu in the different forest types doesn't change 
with size.
