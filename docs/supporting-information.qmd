...
#| tbl-cap: "Posterior estimates of fixed effects from the growth model on the response scale"
...
#| tbl-cap: "Posterior estimates of population-level effects from the survival model. The regression coefficient, $\\beta$, is reported on the link scale and the Weibull scale parameter, $\\lambda$, has been back-transformed to the response scale (years)."
