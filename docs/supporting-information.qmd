...
subtitle: "Contrasting growth trajectories but convergent size-dependent survival of enrichment-planted seedlings in logged and old-growth forests"
knitr:
  opts_chunk: 
    echo: false
    message: false
...
#| tbl-cap: "Posterior estimates of population-level effects from the survival model. The mean of the Weibull distribution, $\\mu$, has been back-transformed to the response scale (years)."
