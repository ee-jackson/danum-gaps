...
#| tbl-cap: "Posterior estimates of population-level effects from the survival model. The Weibull scale parameter, $\\lambda$, has been back-transformed to the response scale (years)."
